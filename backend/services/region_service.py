...
def get_unified_region_data(years=None, region=None, program=None, month=None, quarter=None, group_by="month"):
    ...
    monthly = get_monthly_region_impact(years, region, program, month, quarter, group_by)
...
def get_monthly_region_impact(years=None, region=None, program=None, month=None, quarter=None, group_by="month") -> list[dict]:
