...
def get_data(
    ...
    return instructor_detail_service.get_instructor_detail_data(instructor_name, years, month, quarter, limit, offset, dt_params)
...
def export_data(
    ...
    data = instructor_detail_service.get_instructor_detail_data(instructor_name, years, month, quarter, limit=100000, offset=0)
