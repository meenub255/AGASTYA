...
def vehicle_data(
    ...
    res = get_vehicle_report_data(region, area, years, month, quarter, limit, offset, dt_params)
    if "error" in res:
...
def vehicle_export(
    ...
    data = get_vehicle_report_data(region, area, years, month, quarter, limit=100000, offset=0)
