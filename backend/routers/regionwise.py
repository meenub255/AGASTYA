...
def get_data(
    ...
    return regionwise_service.get_regionwise_data(region, area, years, month, limit, offset, dt_params)
...
def export_data(
    ...
    data = regionwise_service.get_regionwise_data(region, area, years, month, limit=100000, offset=0)
