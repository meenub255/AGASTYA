...
def get_data(
    ...
    return attendance_service.get_attendance_data(region, area, years, month, limit, offset, dt_params)
...
def export_data(
    ...
    data = attendance_service.get_attendance_data(region, area, years, month, limit=100000, offset=0)
