...
def get_instructor_data(
    ...
    return instructor_service.get_unified_instructor_data(years=years, region=region, program=program, instructor=instructor)
...
def instructor_session_log(
    ...
    return instructor_service.get_instructor_session_log(
        years=years, region=region, program=program, instructor=instructor, limit=limit, offset=offset, dt_params=dt_params
    )
...
def export_data(
    ...
    data = instructor_service.get_instructor_session_log(years=years, region=region, program=program, instructor=instructor, limit=100000, offset=0)
